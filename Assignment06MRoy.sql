...
Create -- Drop
	...
	On vCategories.CategoryID = vProducts.CategoryID ---Fixed after assignment review was suppose to use view, not Categories, Products
...
Create -- Drop
	View vProductNamesInventoryCountsbyInventoryDate
		...
		,InventoryDate
		,[Count]
	From vProducts Inner Join vInventories -- Corrected after assignment review, needed to use view tables
...
Create -- Drop
	...
	From vInventories Inner Join vEmployees -- Fixed after assignment review
...
Create -- Drop
	View vCategoriesProductsInvDateCountEmployee
		...
		Select Top 1000000000
			...
			,[Count]
			,[Employee Name] = EmployeeFirstName + ' ' + EmployeeLastName
		From vCategories Inner Join vProducts -- Fixed after assignment review
		On vCategories.CategoryID = vProducts.CategoryID
		Inner Join vInventories
		On vProducts.ProductID = vInventories.ProductID
...
Create -- Drop
	View vInventoriesForChaiAndChangByEmployees
		...
		Select Top 1000000000
			...
			,[Count]
			,[Employee Name] = EmployeeFirstName + ' ' + EmployeeLastName
		From vCategories Inner Join vProducts -- Fixed after assignment review, needed to use view tables
		On vCategories.CategoryID = vProducts.CategoryID
		Inner Join vInventories
		On vProducts.ProductID = vInventories.ProductID
		Inner Join vEmployees
...
Create -- Drop
	View vEmployeesByManager
		...
		From vEmployees E Inner Join Employees M -- fixed after assignment review, needed to use view tables
